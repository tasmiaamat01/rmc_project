<header class="main-header">
    <a href="home.php" class="logo" >
        <img class="main_logo" style="margin-top: 5px; height: 48px;"  src="{{asset('public/frontend/img/axes_logo.svg')}}" />
        <img class="icon_logo" style="    margin-top: 12px;    margin-left:7px;" src="{{asset('public/frontend/img/axes_col.png')}}" />
                ...
                <li class="welmsg">
                    <li class="welmsg">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{asset('public/frontend/img/user/DV-Lo_1586579338.jpg')}}" class="user-image" alt="User Image">
