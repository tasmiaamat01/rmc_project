...
<head>
    ...
    <section class="content">
        ...
        <h3>Search Product And Add To Cart</h3>
                    ...
                    @endif
        <form action="{{ route('add-to-sales-cart') }}" method="POST" id="add_to_cart">
            @csrf
            <div class="row">
                <div class="col-md-12">
        ...
        @endif
            <form method="POST" action="{{ route('update-to-sales-cart') }}">
                @csrf
            <br>
             <span id="result"></span>
        ...
        @if($sales_cart)
           <tbody>
                    <input type="hidden" name="id" readonly="readonly" value="{{ $sales_cart->id }}" class="form-control">
            <tr>
                <td>
                    <input type="hidden" name="item_id" readonly="readonly" value="{{ $sales_cart->item_id }}" class="form-control">
           ...
           @endif
                ...
                <a href="{{ route('view_sales_cart_list') }}" class="btn btn-flat bg-gray  ">Cart List</a>
                </center>
      </form>
