...
@section("content")
    ...
    <h1>Material Use Record Cart List</h1>
        <ol class="breadcrumb">
            <li><a href="home.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
            <li><a href="mas_brandcreate.php">Material Use</a></li>
    ...
    <section class="content">
        ...
        <a href=""  class="btn btn-flat bg-gray  ">Checkout</a> <a type="button" href="" class="btn btn-flat bg-gray  ">Add More</a>
        </div>
        </div>
