           ...
           @csrf
            ...
            <div class="row"style="margin-top: 15px" >
                ...
                <div class="col-md-4 text-right" >
                    <input type="submit" name="save" id="submit" class="btn btn-flat bg-purple btn-sm " value="Save"/> <a href="{{ route('create-bank-list') }}" class="btn btn-flat bg-grayss">Close</a>
                </div> 
            </div>     
        </form>    
        </div>
