...
@section("content")  
    ...
    <section class="content">
        ...
        <div class="box-body">
            ...
            @endif
        <form action="{{route('project-contructor-store-page')}}" onsubmit="return validate()" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            @csrf
            <div class="col-md-12 popup_details_div">
                ...
                <div class="row"style="margin-top: 15px" >
                    ...
                    <div class="col-md-4 text-right" >
                        <input type="submit" name="save_contractor" id="submit" class="btn btn-flat bg-purple btn-sm" value="Save"/> <a href="{{route('project-contructor-list-page')}}" class="btn btn-flat bg-gray">Close</a>
                    </div> 
                </div>     
        </form>    
        </div>
