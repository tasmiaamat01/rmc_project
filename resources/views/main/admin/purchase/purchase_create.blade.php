...
<head>
    ...
    <section class="content">
        ...
        @if($cart)
           <tbody>
                    <input type="hidden" name="id" readonly="readonly" value="{{ $cart->id }}" class="form-control">
            <tr>
                <td>
                    <input type="hidden" name="item_id" readonly="readonly" value="{{ $cart->item_id }}" class="form-control">
