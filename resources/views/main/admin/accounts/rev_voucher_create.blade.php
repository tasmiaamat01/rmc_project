   ...
   $(document).ready(function(){
    ...
    function dynamic_field(number)
    {
     ...
     html = '<tr>';
           ...
           html += '<th style="width:200px;"><select onchange="getNewVal(this);" class="form-control select2" name="receive_from[]" id="supplier_id"><option value="">-Select-</option>@foreach($suppliers as $supplier)<option value="{{$supplier->id}}">{{$supplier->name}}</option>@endforeach</select></th>';
