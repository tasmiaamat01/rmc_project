                ...
                <div class="col-md-12 popup_details_div">
                  ...
                  <div class="row"style="margin-top: 15px" >
                     ...
                     <div class="col-md-4 text-right" >
                        <input type="submit" name="save_zone" id="submit" class="btn btn-flat bg-purple btn-sm " value="Update"/> <a href="mas_countrylist.php" class="btn btn-flat bg-gray  ">Close</a>
                     </div>
                  </div>
               </form>
            </div>
