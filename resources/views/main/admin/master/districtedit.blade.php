...
<section class="content">
    ...
    <input type="submit" name="save_country" id="submit" class="btn btn-flat bg-purple btn-sm " value="Upadte"/> <a href="mas_countrylist.php" class="btn btn-flat bg-gray  ">Close</a>
    </div>
    </div>
    </form>
    </div>
