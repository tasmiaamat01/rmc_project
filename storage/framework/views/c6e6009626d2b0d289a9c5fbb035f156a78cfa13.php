       ...
       <ul class="sidebar-menu tree" data-widget="tree">
         ...
         <?php if(Auth::User()->roles = 'manage_project' || Auth::User()->status = '007'): ?>
          ...
          <li class="treeview">
             ...
             <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-caret-right"></i> Materials Use Record</a></li>
                <li><a href="#"><i class="fa fa-caret-right"></i> Materials Send For Use</a></li>
                <li><a href="#"><i class="fa fa-caret-right"></i> Sales Invoice</a></li>
                <li><a href="#"><i class="fa fa-caret-right"></i> Sales Invoice Create</a></li>
             </ul>
          </li>
          <?php endif; ?>
          ...
          <li class="treeview">
             ...
             <ul class="treeview-menu">
                ...
                <li><a href="<?php echo e(route('combinedstock-list')); ?>"><i class="fa fa-caret-right"></i> Combined Stock</a></li>
                <li><a href="#"><i class="fa fa-caret-right"></i> Transfer From Branch</a></li>
                <li><a href="#"><i class="fa fa-caret-right"></i> Transfer From Warehouse</a></li>
          ...
          <li class="treeview">
             ...
             <ul class="treeview-menu">
                ...
                <li><a href="<?php echo e(route('group-list')); ?>"><i class="fa fa-caret-right"></i> Group List</a></li>
                <li><a href="<?php echo e(route('group-create-route')); ?>"><i class="fa fa-caret-right"></i> Group Cteate</a></li>
                ...
                <li><a href="/rev_voucher_list"><i class="fa fa-caret-right"></i> Receive Voucher List</a></li>
                <li><a href="/rev_voucher_create"><i class="fa fa-caret-right"></i> Receive Voucher Create</a></li>
                <li><a href="/jour_list"><i class="fa fa-caret-right"></i> Journal Entry List</a></li>
                <li><a href="/jour_create"><i class="fa fa-caret-right"></i> Journal Entry Create</a></li>
             </ul>
          </li>
          <?php endif; ?>
          ...
          <li class="treeview">
             ...
             <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-caret-right"></i> Chart of Account</a></li>
                <li><a href="#"><i class="fa fa-caret-right"></i> Profit And Loss</a></li>
                <li><a href="#"><i class="fa fa-caret-right"></i>Trial Balance </a></li>
                <li><a href="#"><i class="fa fa-caret-right"></i> Balance Sheet</a></li>
          ...
          <li class="treeview">
             ...
             <ul class="treeview-menu">
               ...
               <li><a href="#"><i class="fa fa-caret-right"></i> All Transaction</a></li>
               <li><a href="#"><i class="fa fa-caret-right"></i> Add Transaction</a></li>
             </ul>
          </li>
          <?php endif; ?>
          <li class="treeview">
          ...
          <li class="treeview">
             ...
             <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-caret-right"></i> Company Setup</a></li>
                <li><a href="#"><i class="fa fa-caret-right"></i> Local Setting</a></li>
             </ul>
          </li>
          <?php endif; ?>
       </ul>
...
<?php /**PATH /var/www/html/rm_construction/ver-4_28-07/ver-4/resources/views/layouts/admin/aside.blade.php ENDPATH**/ ?>