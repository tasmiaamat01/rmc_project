                                ...
                                <div class="invhold scrol-y" id="invhold">
                                    ...
                                    <div class="col-md-12 cart-border-left text-center">
                                        ...
                                        <div class="text-center header-line-height">
                                            ...
                                            <br> <small><span>Sales From: <?php echo e($data->company_name); ?></span></small> 
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Construction_web\ver_10\resources\views/main/admin/sales/sales_checkout.blade.php ENDPATH**/ ?>