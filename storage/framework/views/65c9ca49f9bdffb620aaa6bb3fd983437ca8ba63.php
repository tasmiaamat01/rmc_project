...
<script>
   ...
   $(document).ready(function(){
    ...
    function dynamic_field(number)
    {
     ...
     html = '<tr>';
           html += '<th style="width:200px;"><select class="form-control select2" onchange="getBalance(this);" name="receive_to[]"><option selected value="">-No Sourch-</option><option value="cash">Cash</option></select></th>';
           html += '<th style="width:50px;"><span>$ </span><span id="sbalance">0.00</span></th>';
           html += '<th style="width:200px;"><select onchange="getNewVal(this);" class="form-control select2" name="receive_from[]" id="supplier_id"><option value="">-Select-</option><?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($supplier->id); ?>"><?php echo e($supplier->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></th>';
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Construction_web\ver_10\resources\views/main/admin/accounts/rev_voucher_create.blade.php ENDPATH**/ ?>