               ...
               <div class="row"style="margin-top: 15px" >
                  <div class="col-md-12 table-responsive">
                     ...
                     <div class="col-md-4 text-right" >
                        <a href="<?php echo e(route('subcategory-create-route',['id' => $subcategory->id])); ?>" class="btn btn-flat bg-purple">Add Sub-Category</a>
                     </div>
                  </div>
               </div>
            </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Projo\Construction\ver-3\resources\views/main/admin/productsetup/product_subcategory_list.blade.php ENDPATH**/ ?>