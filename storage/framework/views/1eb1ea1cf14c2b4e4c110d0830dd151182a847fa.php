...
<head>
    ...
    <section class="content">
        ...
        <h3>Search Product And Add To Cart</h3>
                    ...
                    <?php endif; ?>
        <form action="<?php echo e(route('add-to-sales-cart')); ?>" method="POST" id="add_to_cart">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-md-12">
        ...
        <?php endif; ?>
            <form method="POST" action="<?php echo e(route('update-to-sales-cart')); ?>">
                <?php echo csrf_field(); ?>
            <br>
             <span id="result"></span>
        ...
        <?php if($sales_cart): ?>
           <tbody>
                    <input type="hidden" name="id" readonly="readonly" value="<?php echo e($sales_cart->id); ?>" class="form-control">
            <tr>
                <td>
                    <input type="hidden" name="item_id" readonly="readonly" value="<?php echo e($sales_cart->item_id); ?>" class="form-control">
                    <input type="test" name="item_name" readonly="" value="<?php echo e($sales_cart->item_name); ?>" class="form-control">
                </td>
                <td><input type="text" name="supplier_id" value="<?php echo e($sales_cart->supplier_id); ?>" readonly="readonly" class="form-control"></td>
                <td><input type="text" name="quantity" id="quantity" onchange="return set_quantity()" class="form-control"></td>
                <td><input type="text" name="cost" id="cost" value="<?php echo e($sales_cart->cost); ?>" class="form-control"></td>
           ...
           <?php endif; ?>
                ...
                <a href="<?php echo e(route('view_sales_cart_list')); ?>" class="btn btn-flat bg-gray  ">Cart List</a>
                </center>
      </form>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Construction_web\ver_10\resources\views/main/admin/sales/sales_create.blade.php ENDPATH**/ ?>