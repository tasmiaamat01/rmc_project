                              ...
                              <div class="col-md-3">
                                 <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="district_id" id="did" onchange="getAllSubgroup(this.value)">
                                       ...
                                       <option value="<?php echo e($district->id); ?>"><?php echo e($district->district); ?></option>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Projo\Construction\ver-4\resources\views/main/admin/client_setup/customer_create.blade.php ENDPATH**/ ?>