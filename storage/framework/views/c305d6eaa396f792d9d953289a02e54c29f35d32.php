...
<?php $__env->startSection("content"); ?>  
    ...
    <section class="content">
        ...
        <form action="inv_receivecre.php" id="save_frreceive" onsubmit="return validate()" enctype="multipart/form-data" method="post" accept-charset="utf-8">
        <div class="col-md-12">    
        <div class="row">
        <div class="col-md-4">
        ...
        <input type="text" class="form-control datetimepicker" name="dlidt" id="dlidt" value="" placeholder="Receive Date" autocomplete="off" readonly>
        </div>
        </div>    
        </div> 
        <div class="col-md-8">
        ...
        <input type="hidden" name="save_receiv" class="form-control" value="0" readonly />   
        <input type="button" id="save_receiv" class="btn btn-flat bg-purple btn-sm " value="Receive"/> <a href="inv_receivlist.php" class="btn btn-flat bg-gray  ">Close</a>
        </div> 
        </div>     
        </form>    
        </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Projo\Construction\ver-3\resources\views/main/admin/inventory/receive_create.blade.php ENDPATH**/ ?>