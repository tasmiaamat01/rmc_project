                    ...
                    <div class="form-group" >
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control select2" name="item_id" id="item_id" required>
                                <option value="<?php echo e($cart->item_id); ?>"><?php echo e($cart->item_name); ?></option>
                ...
                <div class="col-md-3">
                    <div class="form-group" >
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" maxlength="45" class="form-control" name="company_name" id="company_name" value="<?php echo e($cart->company_name); ?>" placeholder="e.g. Sumon" autocomplete="off" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group" >
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control select2" name="supplier_id" id="supplier_id" required>
                                <option value="<?php echo e($cart->supplier_id); ?>"><?php echo e($cart->supplier_id); ?></option>
                    ...
                    <div class="form-group" >
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control select2" name="color">
                                <option selected value="<?php echo e($cart->color); ?>"><?php echo e($cart->color); ?></option>
        ...
        <table class="table table-bordered table-striped" id="user_table">
           ...
           <tfoot>
            <tr>
                ...
                <td></td>
                <td><input type="text" name="total" id="total" class="form-control" value="<?php echo e($cart->total); ?>" readonly/></td>
            </tr>
            <tr>
                <td colspan="3">Discount(%)</td>
                <td><input type="text" name="discount" id="discount" onchange="return set_discount()" onkeyup="return set_grand_total()" class="form-control"  value="<?php echo e($cart->discount); ?>"></td>
                <td><input type="text" name="discount_amount" id="discount_amount" class="form-control"  value="<?php echo e($cart->discount_amount); ?>" readonly/></td>
            </tr>
            <tr>
                <td colspan="3">VAT (%)</td>
                <td><input type="text" name="vat" id="vat" class="form-control" onchange="return set_vat()"  onkeyup="return set_grand_total()"  value="<?php echo e($cart->vat); ?>" ></td>
                <td><input type="text" name="vat_amount" id="vat_amount"   value="<?php echo e($cart->vat_amount); ?>" class="form-control" readonly/></td>
            </tr>
            <tr>
                <td colspan="3">TAX (%)</td>
                <td><input type="text" name="tax" id="tax" class="form-control" onchange="return set_tax()"  onkeyup="return set_grand_total()"   value="<?php echo e($cart->tax); ?>" ></td>
                <td><input type="text" name="tax_amount" id="tax_amount"   value="<?php echo e($cart->tax_amount); ?>" class="form-control" readonly/></td>
            </tr>
            <tr>
                <td colspan="3">AIT (%)</td>
                <td><input type="text" name="ait" id="ait" class="form-control" onchange="return set_ait()"  onkeyup="return set_grand_total()"   value="<?php echo e($cart->ait); ?>"></td>
                <td><input type="text" name="ait_amount" id="ait_amount"   value="<?php echo e($cart->ait_amount); ?>" class="form-control" readonly/></td>
            </tr>
            <tr>
                <td colspan="3">Others:</td>
                <td></td>
                <td><input type="text" name="other_amount" id="other_amount" class="form-control" onkeyup="return set_grand_total()"   value="<?php echo e($cart->other_amount); ?>"  ></td>
            </tr>
            <tr>
                <td colspan="3">Speed Money:</td>
                <td></td>
                <td><input type="text" name="speed_money_amount" id="speed_money_amount" class="form-control" onkeyup="return set_grand_total()"  value="<?php echo e($cart->speed_money_amount); ?>" ></td>
            </tr>
            <tr>
                <td colspan="3">Freight:</td>
                <td></td>
                <td><input type="text" name="freight_amount" id="freight_amount" class="form-control" onkeyup="return set_grand_total()"  value="<?php echo e($cart->freight_amount); ?>"></td>
            </tr>
            <tr>
                <td colspan="3">Fractional Discount:    </td>
                <td></td>
                <td><input type="text" name="fraction_discount_amount" id="fraction_discount_amount" onkeyup="return set_grand_total()" class="form-control"  value="<?php echo e($cart->fraction_discount_amount); ?>"></td>
            </tr>
            <tr>
                <td colspan="3">Grand total </td>
                <td></td>
                <td><input type="text" name="grand_total" id="grand_total"   value="<?php echo e($cart->grand_total); ?>" class="form-control" readonly/></td>
            </tr>
            <tr>
            </tr>
           </tfoot>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/rm_construction/purchase/ver-3/resources/views/main/admin/purchase/cart_edit.blade.php ENDPATH**/ ?>