           ...
           <?php echo csrf_field(); ?>
            ...
            <div class="row"style="margin-top: 15px" >
                ...
                <div class="col-md-4 text-right" >
                    <input type="submit" name="save" id="submit" class="btn btn-flat bg-purple btn-sm " value="Save"/> <a href="<?php echo e(route('create-bank-list')); ?>" class="btn btn-flat bg-grayss">Close</a>
                </div> 
            </div>     
        </form>    
        </div>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Projo\Construction\ver-3\resources\views/main/admin/bank/mobileaccount_create.blade.php ENDPATH**/ ?>