...
<?php $__env->startSection("content"); ?>  
    ...
    <section class="content">
        ...
        <td><b class="prodetail" id="" style="cursor: pointer;"></b></td>
        <td></td>
        <td></td>    
        <td class="text-center"></td>
        <td class="text-center"></td>
...
<?php echo $__env->make("layouts/admin/main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/rm_construction/purchase/ver-3/resources/views/main/admin/inventory/warehouse_stock.blade.php ENDPATH**/ ?>